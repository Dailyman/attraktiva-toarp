...
[TargetGroup],[ApproximateAttendees],[AssociationId],[Created],[CreatedBy],[LatestUpdate],[UpdatedBy],[IsDeleted])
     VALUES
		   ...
		   'Kompisar','15',3,'2014-11-01','Robin','2014-11-10','Erica','0')
GO
INSERT INTO [dbo].[Events]([Title],[Description],[Summary],[Other],[Location],[ImageUrl],[LinkUrl],[DayEvent],[StartDate],[EndDate],
[TargetGroup],[ApproximateAttendees],[AssociationId],[Created],[CreatedBy],[LatestUpdate],[UpdatedBy],[IsDeleted])
     VALUES
		   ...
		   'Kompisar','15',10,'2014-11-01','Robin','2014-11-10','Erica','0')
GO
INSERT INTO [dbo].[Events]([Title],[Description],[Summary],[Other],[Location],[ImageUrl],[LinkUrl],[DayEvent],[StartDate],[EndDate],
[TargetGroup],[ApproximateAttendees],[AssociationId],[Created],[CreatedBy],[LatestUpdate],[UpdatedBy],[IsDeleted])
     VALUES
...
[TargetGroup],[ApproximateAttendees],[AssociationId],[Created],[CreatedBy],[LatestUpdate],[UpdatedBy],[IsDeleted])
     VALUES
           ('Klappa hajar','Kom och bekanta dig med våra hajvänner', 'Lek med hajar','Friendly','Grannens pool','http://thumbs.dreamstime.com/x/cute-inflated-shark-5593365.jpg', 'https://www.facebook.com/TheCove?fref=pb&hc_location=profile_browser', '1','2014-12-24','2015-12-24',
		   'Familj och vänner','15',11,'2014-11-26','Robin','2014-11-26','Erica','0')
GO
