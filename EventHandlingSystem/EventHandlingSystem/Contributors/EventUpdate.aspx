...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Panel ID="PanelMain" runat="server">
        ...
        <asp:ImageButton ID="ImageButtonStartDate" runat="server" CssClass="calender-icon" ImageUrl="~/Images/calendar-22x21.png" OnClick="ImageButtonStartDate_OnClick" />
        ...
        <asp:ImageButton ID="ImageButtonEndDate" runat="server" CssClass="calender-icon" ImageUrl="~/Images/calendar-22x21.png" OnClick="ImageButtonEndDate_OnClick" />
